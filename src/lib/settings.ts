...
// The Card (Tooplate 2109)
const THE_CARD_LIGHT: ThemePalette = {
  canvas: '#f2f5f3',
  ink: '#1a2320',
  ...
  field: 'rgba(0, 0, 0, 0.08)',
  focus: '#00ccfc',
}

const THE_CARD_DARK: ThemePalette = {
  canvas: '#25332e',
  ink: '#ffffff',
...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    name: 'The Card',
    settings: {
      theme: { mode: 'dark' as ThemeMode, radius: '0px' },
      colors: { light: THE_CARD_LIGHT, dark: THE_CARD_DARK },
      fonts: {
        body: 'Open Sans',
        heading: 'Open Sans',
        display: 'Open Sans',
